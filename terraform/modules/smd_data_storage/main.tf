...
# tfsec:ignore:aws-s3-enable-bucket-logging   TODO: Enable bucket logging
# tfsec:ignore:aws-s3-enable-versioning The data in this bucket is considered ephemeral and doesnt need to be versioned
