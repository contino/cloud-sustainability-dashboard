...
# tfsec:ignore:aws-s3-enable-bucket-logging Bucket logging not enabled. Implementation left to specific consumer environment.
# tfsec:ignore:aws-s3-enable-versioning Versioning not enabled, query results are short-lived.
